...
[src/helpers/event/deleteEventHelpers/deleteRecurringEventInstances.ts:29](https://github.com/PalisadoesFoundation/talawa-api/blob/708df7e/src/helpers/event/deleteEventHelpers/deleteRecurringEventInstances.ts#L29)
