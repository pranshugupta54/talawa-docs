...
[src/libraries/errors/ImageSizeLimitExceeded.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/708df7e/src/libraries/errors/ImageSizeLimitExceeded.ts#L6)
